...
const customThemeModal: CustomFlowbiteTheme["modal"] = {
  "root": {
  ...
  "body": {
    "base": "flex-col flex-1 overflow-auto p-6",
    "popup": "pt-0"
  },
  "header": {
...
const customThemeButton : {
  color: { pink: string; green: string; lime: string; yellow: string; teal: string; cyan: string; red: string; gray: string; blue: string; light: string; failure: string; success: string; dark: string; purple: string; warning: string; indigo: string; info: string }; gradient: { pink: string; failure: string; success: string; lime: string; purple: string; teal: string; cyan: string; info: string }; isProcessing: string; spinnerLeftPosition: { xl: string; md: string; sm: string; xs: string; lg: string }; fullSized: string; label: string; inner: { outline: string; isProcessingPadding: { xl: string; md: string; sm: string; xs: string; lg: string }; position: { middle: string; start: string; end: string; none: string }; base: string }; pill: { off: string; on: string }; spinnerSlot: string; outline: { color: { default: string; gray: string; light: string }; pill: { off: string; on: string }; off: string; on: string }; size: { xl: string; md: string; sm: string; xs: string; lg: string }; disabled: string; base: string; gradientDuoTone: { redToYellow: string; greenToBlue: string; pinkToOrange: string; cyanToBlue: string; purpleToBlue: string; purpleToPink: string; tealToLime: string }
} = {
